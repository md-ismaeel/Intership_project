        ...
        <>
            ...
            <section className="w-full h-auto overflow-y-auto bg-gray-100">
                <div className="w-[90%] sm:w-[90%] md:max-w-4xl mx-auto min-h-screen flex flex-col md:flex-row items-center justify-center mt-10 mb-10">
                    {/* Left Section */}
                    <div className="w-full md:w-1/2 h-auto md:h-screen bg-orange-500 text-white flex flex-col items-center justify-center p-8 rounded-t-md md:rounded-l-md md:rounded-tr-none lg:rounded-l-md">
                        ...
                        <p className="bg-orange-400 text-white rounded-full px-3 py-1 md:px-4 md:py-2">
                    ...
                    {/* Right Section */}
                    <div className="w-full md:w-1/2 h-auto md:h-screen bg-white flex items-center justify-center p-6 md:p-8 rounded-b-md md:rounded-r-md md:rounded-bl-none lg:rounded-r-md shadow-xl">
                        <form
                            onSubmit={handleSubmit}
                            className="w-full max-w-md flex flex-col gap-3 sm:gap-3"
                        >
                            <div>
                            ...
                            <div className="relative">
                                <button
                                    type="submit"
                                    className={`w-full h-12 py-2 md:py-3 rounded-lg bg-orange-500 text-white font-semibold hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition ${loading && "cursor-not-allowed"
                                        }`}
                                    disabled={loading}
                                >
