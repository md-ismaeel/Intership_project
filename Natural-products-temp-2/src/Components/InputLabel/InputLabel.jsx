...
const IngLabelInput = ({ type = "text", name, value, onChange, placeholder = "", required = false, disabled = false }) => {
  ...
  const styleCss = {
    ...
    inputField: `block w-full px-4 h-[45px] text-bas text-gray-800 border rounded-lg appearance-none transition-colors duration-200 focus:outline-none focus-within:ring-2 focus-within:ring-gray-300  ${disabled ? "opacity-50 cursor-not-allowed" : ""} peer placeholder:text-gray-400`,
